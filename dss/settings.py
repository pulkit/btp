import os
ROOT_PATH = '/home/pulkit/workspace/projects/dss/'
DEBUG = True
...
DATABASES = {
    'default': {
        ...
        'NAME':'dss.db'  ,                   # Or path to database file if using sqlite3.
...
SECRET_KEY = 'fvshtp--+4$ql5x6i2ge6v-r=iwvc$l(5e*g_(%u8oguj5j=a&amp;'
